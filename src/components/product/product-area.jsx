              ...
              <div className="shop-tab f-right mb-40">
                <ul className="nav text-center" id="myTab" role="tablist">
                  <li className="nav-item" role="presentation">
                    <a
                      className={`nav-link ${shop_list ? "" : "active"}`}
                      id="grid-tab"
                      data-bs-toggle="tab"
              ...
              {/* <div className="pro-filter d-flex align-items-center justify-content-end f-right mb-40">
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                  <select name="pro-filter" id="pro-filter">
                    <option className="inner_option" value="1">
                      A to Z Product{" "}
                    </option>
                    <option className="inner_option" value="2">
                      Top Sales{" "}
                    </option>
                    <option className="inner_option" value="3">
                      New Product{" "}
                    </option>
                    <option className="inner_option" value="4">
                      Shop By
                    </option>
                  </select>
                </form>
          ...
          <div className="row">
            <div className="col-12">
              <div className="tab-content" id="myTabContent">
                <div
                  className={`tab-pane fade ${shop_list ? "" : "show active"}`}
                  id="grid-tab-pane"
                  role="tabpanel"
                ...
                >
                  {shop_data.map((item, i) => {
                    const { id, img, title, price, old_price, sm_des } =
                      item || {};
                    return (
                      <div key={i} className="row list_style">
