...
const main_blog_contents = [
  {
    ...
    comments: "23",
    title:
      "Inspired Design Decisions: Bea Feitler, An Unst Oppable Creative Force.",
    sm_des: (
      <>
        There’s a good chance Everyday Health is the most appropriately named
        blog on this list because it focuses on the health topics that
        consistently affect a wide range of people. They also get kudos for
  ...
  },
  {
    ...
    cls: "format-gallery",
    slider: true,
    slider_img: [blog_slider_1, blog_slider_2, blog_slider_3],
    date: "September 15, 2023",
    post_by: "Diboli B. Joly",
    comments: "23",
  ...
  },
  {
    ...
    audio: true,
    audioID:
      "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/698760694&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true",
    img_thumb: blog_thumb_2,
    date: "September 15, 2023",
    post_by: "Diboli B. Joly",
    comments: "23",
        ...
        <article key={i} className={`postbox post ${item.cls} mb-50`}>
          ...
          <div className="postbox__text">
            ...
            <div className="read-more mt-30">
              <a href="#" className="x-btn theme-btn">
                read more
              </a>
            </div>
          </div>
